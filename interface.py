...
class Ui_FitbitWindow(object):
    def setupUi(self, FitbitWindow):
        ...
        self.btnCoeur.setStyleSheet("border-image: url(coeur.jpg);\n"
"border-color: rgb(0, 0, 0);")
        ...
        self.btnLocalisation.setStyleSheet("border-image: url(localisation.jpg);")
        ...
        self.btnHomme.setStyleSheet("border-image: url(homme_qui_court.jpg);")
        ...
        self.btnPas.setStyleSheet("border-image: url(pas.jpg);")
        self.btnPas.setText("")
        ...
        self.btnFeu.setStyleSheet("border-image: url(calorie.jpg);")
        self.btnFeu.setText("")
        ...
        self.btnEscalier.setStyleSheet("border-image: url(etages.jpg);")
        ...
        self.btnEclair.setStyleSheet("border-image: url(minute.jpg);")
